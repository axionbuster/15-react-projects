const reviews = [
  ...
  },
  {
    ...
    image:
      ...
      'v1586883409/person-2_np9x5l.jpg',
    text:
  ...
  },
  {
    ...
    image:
      'https://res.cloudinary.com/diqqf3eq2/image/upload/' +
      'v1586883417/person-3_ipa0mj.jpg',
    text:
      'Sriracha literally flexitarian irony, vape marfa unicorn. Glossier' +
      ' tattooed 8-bit, fixie waistcoat offal activated charcoal ' +
  ...
  },
  {
    ...
    job: 'the boss',
    image:
      'https://res.cloudinary.com/diqqf3eq2/image/upload/v1586883423/' +
      'person-4_t9nxjt.jpg',
    text:
      'Edison bulb put a bird on it humblebrag, marfa pok pok heirloom' +
      ' fashion axe cray stumptown venmo actually seitan. VHS ' +
      'farm-to-table schlitz, edison bulb pop-up 3 wolf moon tote' +
